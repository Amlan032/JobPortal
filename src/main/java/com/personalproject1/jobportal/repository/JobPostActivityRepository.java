...
import com.personalproject1.jobportal.entity.IRecruiterJobs;
...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
    @Query(value = " SELECT COUNT(s.user_id) as totalCandidates,j.job_post_id,j.job_title," +
            ...
            "c.id as companyId,c.name FROM job_post_activity j " +
    ...
    List<JobPostActivity> searchWithoutDate(@Param("job") String job,
                                            ...
                                            @Param("type") List<String> jobType,
                                            @Param("remote") List<String> jobRemoteness);
    ...
    List<JobPostActivity> searchWithDate(@Param("job") String job,
                                         @Param("location") String location,
                                         @Param("type") List<String> jobType,
                                         @Param("remote") List<String> jobRemoteness,
